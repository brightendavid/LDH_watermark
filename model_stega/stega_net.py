# -- coding: utf-8 --
# StegaStamp网络的PyTorch实现，原本为tensorflow代码
import torch
import torch.nn.functional as F
# from kornia.geometry import get_perspective_transform, warp_perspective # 可以直接实现
...
# 5层卷积组成的判别器，个人认为是不重要的
class StegaStampDiscriminator(nn.Module):
    # it returns a tensor float32.and it is differentable.
    def __init__(self):
