...
parser.add_argument('--resume', default=[
    "/home/liu/sjw/save_model/watermark_base/BEST_Encode_07-06watermark_checkpoint3.pth",
   "/home/liu/sjw/save_model/watermark_base/BEST_Hide_07-06watermark_checkpoint3.pth",
    "/home/liu/sjw/save_model/watermark_base/BEST_Reveal_07-06watermark_checkpoint3.pth",
...
def noise_layer(contain, OUT_SECRET, epoch=0, is_test=False):
    ...
    if random.randint(0, 2) % 3 == 1:
        # 加入光照和对比度变化
        brighten_layer = get_rnd_brightness(0.1, 0.1, batch_size).cuda()
    ...
    for batch_index, input_data in enumerate(dataParser):
        if batch_index % 8 == 0:
            ...
            with torch.set_grad_enabled(False):
                ...
                contain, _ = noise_layer(contain, secrets_in, epoch,is_test=True)
                ...
                writer.add_image('secrets_in:%d' % batch_index,
                                 make_grid(secrets_in, nrow=2), global_step=epoch)
